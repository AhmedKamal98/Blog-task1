...
$SQL = "SELECT posts.title, posts.content, posts.publish_date,categories.name
  FROM posts INNER JOIN categories ON posts.category_id=categories.id GROUP BY posts.publish_date DESC LIMIT 4;";
